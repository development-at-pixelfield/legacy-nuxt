...
d>=55296&&d<=57343&&(d=65536+((d&1023)<<10)|a.charCodeAt(++b)&1023);d<=127?++c:c=d<=2047?c+2:d<=65535?c+3:c+4}c=Array(c+1);b=0;d=c.length;if(d>0){d=b+d-1;for(var k=0;k<a.length;++k){var e=a.charCodeAt(k);if(e>=55296&&e<=57343){var f=a.charCodeAt(++k);e=65536+((e&1023)<<10)|f&1023}if(e<=127){if(b>=d)break;c[b++]=e}else{if(e<=2047){if(b+1>=d)break;c[b++]=192|e>>6}else{if(e<=65535){if(b+2>=d)break;c[b++]=224|e>>12}else{if(b+3>=d)break;c[b++]=240|e>>18;c[b++]=128|e>>12&63}c[b++]=128|e>>6&63}c[b++]=128|
...
this}m=m||{};var a=typeof m!=="undefined"?m:{}; var Ga=!1; var Ha=!1;a.onRuntimeInitialized=function(){Ga=!0;if(Ha&&typeof a.onModuleLoaded==="function")a.onModuleLoaded(a)};a.onModuleParsed=function(){Ha=!0;if(Ga&&typeof a.onModuleLoaded==="function")a.onModuleLoaded(a)};a.isVersionSupported=function(a){if(typeof a!=="string")return!1;a=a.split(".");return a.length<2||a.length>3?!1:a[0]==1&&a[1]>=0&&a[1]<=3?!0:a[0]!=0||a[1]>10?!1:!0};var ha={}; var W;for(W in a)a.hasOwnProperty(W)&&(ha[W]=a[W]);var na="./this.program";
var ea=!1; var Z=!1; var oa=!1; var fb=!1; var Ia=!1;ea=typeof window==="object";Z=typeof importScripts==="function";oa=(fb=typeof process==="object"&&typeof process.versions==="object"&&typeof process.versions.node==="string")&&!ea&&!Z;Ia=!ea&&!oa&&!Z;var M=""; var pa; var qa;if(oa){M=__dirname+"/";var ra=function(a,c){pa||(pa=require("fs"));qa||(qa=require("path"));a=qa.normalize(a);return pa.readFileSync(a,c?null:"utf8")};var la=function(a){a=ra(a,!0);a.buffer||(a=new Uint8Array(a));t(a.buffer);return a};process.argv.length>1&&
(na=process.argv[1].replace(/\\/g,"/"));process.argv.slice(2);process.on("uncaughtException",function(a){throw a;});process.on("unhandledRejection",z);a.inspect=function(){return"[Emscripten Module object]"}}else if(Ia)typeof read!="undefined"&&(ra=function(a){return read(a)}),la=function(a){if(typeof readbuffer==="function")return new Uint8Array(readbuffer(a));a=read(a,"binary");t(typeof a==="object");return a},typeof print!=="undefined"&&(typeof console==="undefined"&&(console={}),console.log=print,
...
var Y=a.printErr||console.warn.bind(console);for(W in ha)ha.hasOwnProperty(W)&&(a[W]=ha[W]);ha=null;a.thisProgram&&(na=a.thisProgram);var da;a.wasmBinary&&(da=a.wasmBinary);typeof WebAssembly!=="object"&&Y("no native wasm support detected");var ia; var gb=new WebAssembly.Table({initial:381,maximum:381,element:"anyfunc"}); var za=!1; var xa=typeof TextDecoder!=="undefined"?new TextDecoder("utf8"):void 0;typeof TextDecoder!=="undefined"&&new TextDecoder("utf-16le");var T; var ca; var P; var Ja=a.TOTAL_MEMORY||16777216;if(ia=a.wasmMemory?
        ? a.wasmMemory
...
get64(){var a=R.get();R.get();return a},getZero(){R.get()}},Ka={__cxa_allocate_exception(a){return ib(a)},__cxa_throw(a,c,b){"uncaught_exception"in ta?ta.uncaught_exceptions++:ta.uncaught_exceptions=1;throw a;},abort(){z()},emscripten_get_sbrk_ptr(){return 18416},emscripten_memcpy_big(a,c,b){ca.set(ca.subarray(c,c+b),a)},emscripten_resize_heap(a){if(2147418112<a)return!1;for(var c=Math.max(T.length,16777216);c<a;)c=536870912>=
c?e(2*c,65536):Math.min(e((3*c+2147483648)/4,65536),2147418112);a:{try{ia.grow(c-ka.byteLength+65535>>16);l(ia.buffer);var b=1;break a}catch(d){}b=void 0}return b?!0:!1},environ_get(a,c){var b=0;ba().forEach(function(d,e){var f=c+b;e=P[a+4*e>>2]=f;for(f=0;f<d.length;++f)T[e++>>0]=d.charCodeAt(f);T[e>>0]=0;b+=d.length+1});return 0},environ_sizes_get(a,c){var b=ba();P[a>>2]=b.length;var d=0;b.forEach(function(a){d+=a.length+1});P[c>>2]=d;return 0},fd_close(a){return 0},fd_seek(a,
c,b,d,e){return 0},fd_write(a,c,b,d){try{for(var e=0,f=0;f<b;f++){for(var g=P[c+8*f>>2],k=P[c+(8*f+4)>>2],h=0;h<k;h++)R.printChar(a,ca[g+h]);e+=k}P[d>>2]=e;return 0}catch(ua){return"undefined"!==typeof FS&&ua instanceof FS.ErrnoError||z(ua),ua.errno}},memory:ia,setTempRet0(a){},table:gb},La=function(){function e(c,b){a.asm=c.exports;aa--;a.monitorRunDependencies&&a.monitorRunDependencies(aa);aa==0&&(sa!==null&&(clearInterval(sa),sa=null),ja&&(c=ja,ja=null,c()))}function c(a){e(a.instance)}
        function b(a) {
          return Ma()
            .then(function (a) {
